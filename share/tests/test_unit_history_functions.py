...
def test_history_to_panel_month():
    ...
    output_df = pd.DataFrame({
        ...
        'month': pd.to_datetime([
            ...
            '2000-03-01', '1999-12-01', '2000-01-01',
            ]),
        'unit2': [10, 10, 10, 15, 8, 8]},
        columns=['month', 'event', 'unit2', 'UID2'])

    results = unit_history_functions.history_to_panel(input_df,
                                                      **input_args)
    assert results.equals(output_df)

def test_history_to_panel_month_allow_dups_False():
    '''test history_to_panel for frequency = month with allow_dups False'''
    input_df = pd.DataFrame(
        {'UID': [1, 1, 1],
         'unit': [10, 15, 7],
         'unit_start_date': ['1999-11-01', '2000-03-02', '2000-03-26'],
         'unit_end_date': ['2000-03-01', '2000-03-25', '2000-04-06']})
    input_args = {'frequency': 'month',
                  'max_date': '2000-04-30',
                  'min_date': '1999-12-01',
                  'start': 'unit_start_date',
