...
'''merge script for TRR-statuses_2004-2016_2016-09'''
...
def get_setup():
    ...
    args = {
        ...
        'intrafile_id': 'TRR-statuses_2004-2016_2016-09_ID',
        ...
        'loop_merge' : {
            ...
            'cycle' : 'sup',
            'custom_merges' : [
                {'cols' : ['first_name_NS', 'last_name_NS'],
                 'query' : 'first_name_NS == "JAMES" & last_name_NS == "ROUSSELL"'}
            ]
        }
    }
